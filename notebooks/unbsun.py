...
class dataroot(GeneratedsSuper):
    ...
    def __init__(self, generated=None, TestbedSunJun13Flows=None):
        ...
        if TestbedSunJun13Flows is None:
            self.TestbedSunJun13Flows = []
        else:
            self.TestbedSunJun13Flows = TestbedSunJun13Flows
    ...
    def get_TestbedSunJun13Flows(self): return self.TestbedSunJun13Flows
    def set_TestbedSunJun13Flows(self, TestbedSunJun13Flows): self.TestbedSunJun13Flows = TestbedSunJun13Flows
    def add_TestbedSunJun13Flows(self, value): self.TestbedSunJun13Flows.append(value)
    def insert_TestbedSunJun13Flows_at(self, index, value): self.TestbedSunJun13Flows.insert(index, value)
    def replace_TestbedSunJun13Flows_at(self, index, value): self.TestbedSunJun13Flows[index] = value
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='dataroot', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            ...
            eol_ = ''
        for TestbedSunJun13Flows_ in self.TestbedSunJun13Flows:
            TestbedSunJun13Flows_.export(outfile, level, namespace_, name_='TestbedSunJun13Flows', pretty_print=pretty_print)
    def build(self, node):
        already_processed = set()
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'TestbedSunJun13Flows':
            obj_ = TestbedSunJun13Flows.factory()
            obj_.build(child_)
            self.TestbedSunJun13Flows.append(obj_)
            obj_.original_tagname_ = 'TestbedSunJun13Flows'
# end class dataroot


class TestbedSunJun13Flows(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, appName=None, totalSourceBytes=None, totalDestinationBytes=None, totalDestinationPackets=None, totalSourcePackets=None, sourcePayloadAsBase64=None, sourcePayloadAsUTF=None, destinationPayloadAsBase64=None, destinationPayloadAsUTF=None, direction=None, sourceTCPFlagsDescription=None, destinationTCPFlagsDescription=None, source=None, protocolName=None, sourcePort=None, destination=None, destinationPort=None, startDateTime=None, stopDateTime=None, Tag=None):
        ...
        self.validate_totalSourceBytesType(self.totalSourceBytes)
        self.totalDestinationBytes = totalDestinationBytes
        self.validate_totalDestinationBytesType(self.totalDestinationBytes)
        self.totalDestinationPackets = totalDestinationPackets
        self.validate_totalDestinationPacketsType(self.totalDestinationPackets)
        self.totalSourcePackets = totalSourcePackets
        self.validate_totalSourcePacketsType(self.totalSourcePackets)
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, TestbedSunJun13Flows)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if TestbedSunJun13Flows.subclass:
            return TestbedSunJun13Flows.subclass(*args_, **kwargs_)
        else:
            return TestbedSunJun13Flows(*args_, **kwargs_)
    factory = staticmethod(factory)
    ...
    def validate_totalSourceBytesType(self, value):
        # Validate type totalSourceBytesType, a restriction on xsd:string.
        if value is not None and Validate_simpletypes_:
            if len(value) > 255:
                warnings_.warn('Value "%(value)s" does not match xsd maxLength restriction on totalSourceBytesType' % {"value" : value.encode("utf-8")} )
    def validate_totalDestinationBytesType(self, value):
        # Validate type totalDestinationBytesType, a restriction on xsd:string.
        if value is not None and Validate_simpletypes_:
            if len(value) > 255:
                warnings_.warn('Value "%(value)s" does not match xsd maxLength restriction on totalDestinationBytesType' % {"value" : value.encode("utf-8")} )
    def validate_totalDestinationPacketsType(self, value):
        # Validate type totalDestinationPacketsType, a restriction on xsd:string.
        if value is not None and Validate_simpletypes_:
            if len(value) > 255:
                warnings_.warn('Value "%(value)s" does not match xsd maxLength restriction on totalDestinationPacketsType' % {"value" : value.encode("utf-8")} )
    def validate_totalSourcePacketsType(self, value):
        # Validate type totalSourcePacketsType, a restriction on xsd:string.
        if value is not None and Validate_simpletypes_:
            if len(value) > 255:
                warnings_.warn('Value "%(value)s" does not match xsd maxLength restriction on totalSourcePacketsType' % {"value" : value.encode("utf-8")} )
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='', name_='TestbedSunJun13Flows', namespacedef_='', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='TestbedSunJun13Flows')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='', name_='TestbedSunJun13Flows', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='TestbedSunJun13Flows'):
        pass
    def exportChildren(self, outfile, level, namespace_='', name_='TestbedSunJun13Flows', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.totalSourceBytes is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%stotalSourceBytes>%s</%stotalSourceBytes>%s' % (namespace_, self.gds_encode(self.gds_format_string(quote_xml(self.totalSourceBytes), input_name='totalSourceBytes')), namespace_, eol_))
        if self.totalDestinationBytes is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%stotalDestinationBytes>%s</%stotalDestinationBytes>%s' % (namespace_, self.gds_encode(self.gds_format_string(quote_xml(self.totalDestinationBytes), input_name='totalDestinationBytes')), namespace_, eol_))
        if self.totalDestinationPackets is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%stotalDestinationPackets>%s</%stotalDestinationPackets>%s' % (namespace_, self.gds_encode(self.gds_format_string(quote_xml(self.totalDestinationPackets), input_name='totalDestinationPackets')), namespace_, eol_))
        if self.totalSourcePackets is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%stotalSourcePackets>%s</%stotalSourcePackets>%s' % (namespace_, self.gds_encode(self.gds_format_string(quote_xml(self.totalSourcePackets), input_name='totalSourcePackets')), namespace_, eol_))
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'appName':
            ...
            totalSourceBytes_ = child_.text
            totalSourceBytes_ = self.gds_validate_string(totalSourceBytes_, node, 'totalSourceBytes')
            self.totalSourceBytes = totalSourceBytes_
            # validate type totalSourceBytesType
            self.validate_totalSourceBytesType(self.totalSourceBytes)
        elif nodeName_ == 'totalDestinationBytes':
            totalDestinationBytes_ = child_.text
            totalDestinationBytes_ = self.gds_validate_string(totalDestinationBytes_, node, 'totalDestinationBytes')
            self.totalDestinationBytes = totalDestinationBytes_
            # validate type totalDestinationBytesType
            self.validate_totalDestinationBytesType(self.totalDestinationBytes)
        elif nodeName_ == 'totalDestinationPackets':
            totalDestinationPackets_ = child_.text
            totalDestinationPackets_ = self.gds_validate_string(totalDestinationPackets_, node, 'totalDestinationPackets')
            self.totalDestinationPackets = totalDestinationPackets_
            # validate type totalDestinationPacketsType
            self.validate_totalDestinationPacketsType(self.totalDestinationPackets)
        elif nodeName_ == 'totalSourcePackets':
            totalSourcePackets_ = child_.text
            totalSourcePackets_ = self.gds_validate_string(totalSourcePackets_, node, 'totalSourcePackets')
            self.totalSourcePackets = totalSourcePackets_
            # validate type totalSourcePacketsType
            self.validate_totalSourcePacketsType(self.totalSourcePackets)
            ...
            self.validate_TagType(self.Tag)
# end class TestbedSunJun13Flows
